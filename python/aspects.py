"""Definición de los ciclos mostrados por la calculadora."""

ASPECTS = (
    {"key": "fisico", "label": "Físico", "period": 23, "color": "#1656c9", "dash": (), "group": "basico"},
    {"key": "emocional", "label": "Emocional", "period": 28, "color": "#d32f2f", "dash": (), "group": "basico"},
    {"key": "intelectual", "label": "Intelectual", "period": 33, "color": "#1f9254", "dash": (), "group": "basico"},
